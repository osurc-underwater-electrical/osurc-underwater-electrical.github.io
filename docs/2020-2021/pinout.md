...
Here is what part of the pinout (the P1 connector in this case) looks like on a PCB in 2d view.  Notice that the implementation of the board has a different orientation than that of the schematic.
